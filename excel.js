  ...
  function curveToRows(curve) {
    return TENOR_ORDER.map((t) => {
      ...
      return {
        ...
        'Bid Outright': roundOrBlank(c.bidOutright),
        'Offer Outright': roundOrBlank(c.offerOutright),
        'Bid Premium': roundOrBlank(c.bidPremium),
        'Offer Premium': roundOrBlank(c.offerPremium),
        'Premium Spread': roundOrBlank(c.spreadPremium),
        'Bid Premium/Day': roundOrBlank(c.bidPremiumPerDay, 4),
        'Offer Premium/Day': roundOrBlank(c.offerPremiumPerDay, 4),
        'Bid Annualized %': roundOrBlank(c.bidAnnualized),
        'Offer Annualized %': roundOrBlank(c.offerAnnualized),
      };
    });
  }
